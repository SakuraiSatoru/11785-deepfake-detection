'''
Copied from https://pytorch.org/docs/stable/_modules/torchvision/models/densenet.html
'''
...
def _simple_densenet(arch, growth_rate, block_config, num_init_features, pretrained, progress,
              **kwargs):
    model = SimpleDenseNet(growth_rate, block_config, num_init_features, **kwargs)
    if pretrained:
...
def simple_densenet169(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_
    """
    return _simple_densenet('densenet169', 32, (6, 12, 32, 32), 64, pretrained, progress,
                     **kwargs)

...
val_loader = DataLoader(val_dataset, batch_size=64, num_workers=8, shuffle=True)
...
densenet = models.densenet169(pretrained=False, progress=True, memory_efficient=True)
